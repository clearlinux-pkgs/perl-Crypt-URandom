...
Source0  : https://cpan.metacpan.org/authors/id/D/DD/DDICK/Crypt-URandom-0.53.tar.gz
...
%prep
%setup -q -n Crypt-URandom-0.53
cd %{_builddir}/Crypt-URandom-0.53
pushd ..
cp -a Crypt-URandom-0.53 buildavx2
popd
