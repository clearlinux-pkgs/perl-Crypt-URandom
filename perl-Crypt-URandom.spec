...
Source0  : https://cpan.metacpan.org/authors/id/D/DD/DDICK/Crypt-URandom-0.51.tar.gz
...
%prep
%setup -q -n Crypt-URandom-0.51
cd %{_builddir}/Crypt-URandom-0.51
pushd ..
cp -a Crypt-URandom-0.51 buildavx2
popd
