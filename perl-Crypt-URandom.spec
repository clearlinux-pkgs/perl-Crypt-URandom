...
Source0  : https://cpan.metacpan.org/authors/id/D/DD/DDICK/Crypt-URandom-0.52.tar.gz
...
%prep
%setup -q -n Crypt-URandom-0.52
cd %{_builddir}/Crypt-URandom-0.52
pushd ..
cp -a Crypt-URandom-0.52 buildavx2
popd
